            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$pa->question}}</td>
                  <td height="75px">
                     <form action="{{url('/faqstatus/'.$pa->id)}}" method="POST">
                      {{csrf_field()}}
                    <div class="btn-group">
                 ...
                 @else
                  ...
                  <td>
                    <a href="{{url('/editfaq/'.$pa->id)}}"><button class="btn btn-info"><i class="fa fa-edit"></i></button></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        @endif
        <br>
        <strong>Question : {{$t->question}}?</strong>
