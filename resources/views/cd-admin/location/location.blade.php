        ...
        <div class="col-xs-12">
           <div class="box">
            <div class="box-header">
              <h3 class="box-title">
                 <a href="{{url('/location-add')}}"><button class="btn btn-success" style="margin-bottom: 10px; ">Add Location</button></a>
              </h3>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$pa->name}}</td>
                  <td height="75px">
                     <form action="{{url('/locationstatus/'.$pa->id)}}" method="POST">
                      {{csrf_field()}}
                    <div class="btn-group">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
               ...
               <a href="{{url('/deletelocation/'.$t->id)}}"> <button type="button" class="btn btn-outline">Yes</button></a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
