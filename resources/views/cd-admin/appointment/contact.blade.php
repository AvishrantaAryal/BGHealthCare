   ...
   <div class="col-md-12">
        ...
        @endif
            ...
            <div class="box-body no-padding">
                 <a href="{{url('/view-appointment')}}"><button type="button" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></button></a>
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <?php $test = App\Appointmentreply::where('contact_id',$contact->id)->orderBy('id','desc')->get()->first();
                         ?>
                         @if($test=='')
                      ...
                      <td class="mailbox-name">{{$contact->name}}
                       <td class="mailbox-subject">{{$contact->service}}
                      </td>
                    </td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
         <a href="{{url('/reply-appointment/'.$er->id)}}"><button type="submit" class="btn btn-primary pull-left">Reply</button></a>
...
<div class="modal modal-danger fade" id="modal-danger{{$er['id']}}">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <a href="{{url('/delete-appointment/'.$er['id'])}}"> <button type="button" class="btn btn-outline">Yes</button></a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
