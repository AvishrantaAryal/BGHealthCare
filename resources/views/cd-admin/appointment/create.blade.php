...
<div class="row">
  <div class="col-md-12 box1">
    <div class="box box-default">
      ...
      <div class="box-body">
        <!-- Date dd/mm/yyyy -->
        <form role="form" method="post" action= "{{url('store-appointment')}}" enctype="multipart/form-data">
            {{csrf_field()}}
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="location"  id="subject" placeholder="Enter subject">
