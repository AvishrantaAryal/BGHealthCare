   ...
   <div class="col-md-12">
        ...
        @endif
            ...
            <div class="box-body no-padding">
              <a href="{{url('/appointment-replies')}}"> <button type="button" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></button></a>
...
<div class="modal modal-danger fade" id="modal-danger{{$t->id}}">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <a href="{{url('/delete-appointmentreply/'.$t->id)}}"> <button type="button" class="btn btn-outline">Yes</button></a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
